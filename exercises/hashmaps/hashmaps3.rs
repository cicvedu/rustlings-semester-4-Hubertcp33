...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        let team1_entry = scores.entry(team_1_name).or_insert(Team { goals_scored: 0, goals_conceded: 0 });  
        team1_entry.goals_scored += team_1_score;  
        team1_entry.goals_conceded += team_2_score;  
  
        // Update scores for team 2  
        let team2_entry = scores.entry(team_2_name).or_insert(Team { goals_scored: 0, goals_conceded: 0 });  
